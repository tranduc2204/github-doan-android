...
public class activity_quen_mat_khau extends Activity {
    TextView txtNoiDung;
    EditText txtMSNV;
    Button btnGui;
    ImageButton back;
        ...
        try {
            ...
            registerReceiver(new BroadcastReceiver() {
                public void onReceive(Context context, Intent intent) {
                    ...
                    Toast.makeText(activity_quen_mat_khau.this, msg, Toast.LENGTH_LONG).show();
    ...
    private void addControls() {
        ...
        txtNoiDung = (TextView) findViewById(R.id.txtNoiDung1);
        txtMSNV = (EditText) findViewById(R.id.txtMSNV1);

...
public class activity_nhap_cong extends Activity {
    ...
    private void addControls() {
        ...
        txtMaNhanVien = (EditText) findViewById(R.id.etmanv);
    ...
    private void xuLySaoChepCSDLTuAssetsVaoHeThongMobile() {
        ...
        if (!dbFile.exists()) {
            try {
                ...
                Toast.makeText(activity_nhap_cong.this, "Sao chep database thanh cong", Toast.LENGTH_SHORT).show();

            } catch (Exception e) {
                Toast.makeText(activity_nhap_cong.this, e.toString(), Toast.LENGTH_SHORT).show();

...
public class activity_sua_chua_thong_tin extends Activity {
    ...
    private void xuLySaoChepCSDLTuAssetsVaoHeThongMobile() {
        ...
        if (!dbFile.exists()) {
            try {
                ...
                Toast.makeText(activity_sua_chua_thong_tin.this, "Sao chep database thanh cong", Toast.LENGTH_SHORT).show();

            } catch (Exception e) {
                Toast.makeText(activity_sua_chua_thong_tin.this, e.toString(), Toast.LENGTH_SHORT).show();
    ...
    private void addControls() {
        ...
        txtHoKhau = (EditText) findViewById(R.id.txtHoKhau1);
        txtNguyenQuan = (EditText) findViewById(R.id.txtNguyenQuan1);
        txtTonGiao = (EditText) findViewById(R.id.txtTonGiao1);
        txtPhone = (EditText) findViewById(R.id.txtPhone1);
        txtEmail = (EditText) findViewById(R.id.txtEmail1);

        autotxtDanToc = (AutoCompleteTextView) findViewById(R.id.autotxtDanToc1);
        arrDanToc = getResources().getStringArray(R.array.arrDanTocc);
        adapterDanToc = new ArrayAdapter<String>(activity_sua_chua_thong_tin.this, android.R.layout.simple_list_item_1, arrDanToc);
        autotxtDanToc.setAdapter(adapterDanToc);


        spGioiTinh = (Spinner) findViewById(R.id.spGioiTinh1);
        spNgaySinh = (Spinner) findViewById(R.id.spNgaySinh1);
        spThangSinh = (Spinner) findViewById(R.id.spThangSinh1);
        spNamSinh = (Spinner) findViewById(R.id.spNamSinh1);
        spPhongBan = (Spinner) findViewById(R.id.spPhongBan1);
        spHonNhan = (Spinner) findViewById(R.id.spHonNhan1);

        addDSGioiTinh();
        adapterGioiTinh = new ArrayAdapter<String>(activity_sua_chua_thong_tin.this, android.R.layout.simple_list_item_checked,
                dsGioiTinh);
        adapterGioiTinh.setDropDownViewResource(android.R.layout.simple_list_item_checked);
        spGioiTinh.setAdapter(adapterGioiTinh);

        addDSNgaySinh();
        adapterNgaySinh = new ArrayAdapter<String>(activity_sua_chua_thong_tin.this, android.R.layout.simple_spinner_item
                , dsNgaySinh);
        ...
        addDSTThangSinh();
        adapterThangSinh = new ArrayAdapter<String>(activity_sua_chua_thong_tin.this, android.R.layout.simple_spinner_item
                , dsThangSinh);
        ...
        addDSNamSinh();
        adapterNamSinh = new ArrayAdapter<String>(activity_sua_chua_thong_tin.this, android.R.layout.simple_spinner_item
                , dsNamSinh);
        adapterNamSinh.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spNamSinh.setAdapter(adapterNamSinh);

        addDSPhongBan();
        adapterPhongBan = new ArrayAdapter<String>(activity_sua_chua_thong_tin.this, android.R.layout.simple_list_item_checked
                , dsPhongBan);
        adapterPhongBan.setDropDownViewResource(android.R.layout.simple_list_item_checked);
        spPhongBan.setAdapter(adapterPhongBan);

        addDSHonNhan();
        adapterHonNhan = new ArrayAdapter<String>(activity_sua_chua_thong_tin.this, android.R.layout.simple_list_item_checked
                , dsHonNhan);
